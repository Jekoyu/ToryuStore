  ...
  <div class="container">
    ...
    <div class="container mt-5">
      <div class="row mb-4 d-flex-between">
        <div class="col-md-3">
          <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserModal">Tambah Pengguna</button>
        </div>
          ...
          <tbody id="userTableBody">
            <?php foreach ($users as $key => $user): ?>
              <tr>
                ...
                <td><?= $user['no_hp'] ?></td>
                <td>
                  <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editUserModal" onclick="editUser(<?= $user['id'] ?>, '<?= $user['nama_user'] ?>', '<?= $user['email'] ?>', '<?= $user['no_hp'] ?>')">Edit</button>
                  <form action="" method="post" style="display:inline;">
                    <input type="hidden" name="id" value="<?= $user['id'] ?>">
                    <button type="submit" name="deleteUser" class="btn btn-danger btn-sm">Hapus</button>
                  </form>
                </td>
              </tr>
            <?php endforeach; ?>
